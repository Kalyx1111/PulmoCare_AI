...
title PulmoCare AI - Download Offline Packages
...
echo.
echo  ================================================================
echo   PulmoCare AI  -  OFFLINE PACKAGE DOWNLOADER
echo  ================================================================
echo.
...
if "%PIP%"=="" (echo   [FAIL]  pip not found. Run START_PulmoCare_AI.bat first. & pause & exit /b 1)
...
echo.
echo  ================================================================
echo   DONE. PulmoCare AI now works WITHOUT internet connection.
echo   Run START_PulmoCare_AI.bat to launch.
echo  ================================================================
echo.
pause
